...
(function() {
  ...
  root.KiiSiteInternal = {
    DEV: "https://dev-ufe-jp.internal.kii.com/api"
  };
  ...
  */
  ...
  root.Kii = (function() {
    ...
    */
    ...
    Kii.bucketWithName = function(bucketName) {
      return new KiiBucket._bucketWithName(bucketName, null);
    };
    ...
    Kii.authenticateAsAppAdmin = function(clientId, clientSecret, callbacks) {
      ...
      authCallbacks = {
        success: function(data) {
          ...
          id = data.id;
          Kii.logger("token: " + token);
          Kii.logger("id: " + id);
          admin = new KiiAppAdminContext({
            token: token,
            id: id
          });
          if (callbacks != null) {
        ...
        failure: function(error, statusCode) {
          Kii.logger("error: " + error);
          Kii.logger("statusCode: " + statusCode);
          if (callbacks != null) {
  ...
  _Kii = (function() {
    ...
    function _Kii(appID, appKey, site) {
      if (site === KiiSite.JP) {
        site = KiiSite.JP;
      } else if (site === KiiSiteInternal.DEV) {
        site = KiiSiteInternal.DEV;
      } else {
        site = KiiSite.US;
      }
  ...
  root.KiiACL = (function() {
    ...
    */
    ...
    KiiACL.prototype._groupWithID = function(id) {
      ...
      group = KiiGroup._groupWithID(id);
      return group;
    };
  ...
  root.KiiACLEntry = (function() {
    ...
    */
    ...
    KiiACLEntry.prototype.setSubject = function(value) {
      if (value instanceof KiiGroup || value instanceof KiiUser || value instanceof KiiAnyAuthenticatedUser || value instanceof KiiAnonymousUser) {
    ...
    */
    ...
    KiiACLEntry.prototype.getEntityString = function() {
      ...
      if (this._subject instanceof KiiGroup) {
        entityId = this._subject.getUUID();
        type = "GroupID";
      } else if (this._subject instanceof KiiUser) {
        entityId = this._subject.getUUID();
        type = "UserID";
      } else if (this._subject instanceof KiiAnyAuthenticatedUser) {
        type = "UserID";
        entityId = "ANY_AUTHENTICATED_USER";
      } else if (this._subject instanceof KiiAnonymousUser) {
        type = "UserID";
  ...
  */
  ...
  root.KiiBucket = (function() {
    ...
    */
    ...
    function KiiBucket(bucketName, parent) {
      ...
      if (parent != null) {
        if (parent instanceof KiiGroup) {
          this._group = parent;
        } else if (parent instanceof KiiUser) {
          this._user = parent;
        }
      }
    }
    ...
    KiiBucket._bucketWithName = function(bucketName, parent) {
      ...
      bucket = new KiiBucket(bucketName, parent);
      return bucket;
    };
  ...
  root.KiiBucketAdmin = (function(_super) {
    ...
    KiiBucketAdmin.prototype.createObject = function() {
      return KiiObjectAdmin.objectWithBucket(this, null, this._adminToken);
    };

    KiiBucketAdmin.prototype.createObjectWithType = function(type) {
      return KiiObjectAdmin.objectWithBucket(this, type, this._adminToken);
    };

    KiiBucketAdmin.prototype.acl = function() {
      var acl;

      acl = new KiiACLAdmin(this, this._adminToken);
      return acl;
    };
  ...
  root.KiiGroup = (function() {
    ...
    */
    ...
    KiiGroup.prototype.bucketWithName = function(bucketName) {
      ...
      bucket = new KiiBucket(name, this);
      return bucket;
    };
    ...
    */
    ...
    KiiGroup.prototype.getMemberList = function(callbacks) {
      ...
      listCallbacks = {
        success: function(data, statusCode) {
          var member, memberList, members;

          if (statusCode < 300 && statusCode >= 200) {
            memberList = [];
            for (members in data) {
              if (!__hasProp.call(data, members)) continue;
              member = data[members];
    ...
    */
    ...
    KiiGroup.prototype.refresh = function(callbacks) {
      ...
      refreshCallbacks = {
        success: function(data, statusCode) {
          _thisGroup = KiiGroup._groupWithJSON(data);
          if (callbacks != null) {
            return callbacks.success(_thisGroup);
          }
        },
    ...
    */
    ...
    KiiGroup._groupWithJSON = function(json) {
      ...
      if (json.owner != null) {
        group._setOwner(KiiGroup._userWithID(json.owner));
      }
      return group;
    };
    ...
    KiiObject.objectWithURI = function(uri) {
      ...
      if (compLength >= 4) {
        ...
        if (components[0] === "groups") {
          group = new KiiGroup._groupWithID(components[1]);
        } else if (components[0] === "users") {
          user = KiiObject._userWithID(components[1]);
        }
        subject = null;
        if (group != null) {
          subject = group;
        ...
        bucket = new KiiBucket._bucketWithName(bucketName, subject);
        Kii.logger(bucket);
  ...
  root.KiiUser = (function() {
    ...
    */
    ...
    KiiUser.prototype.bucketWithName = function(bucketName) {
      return new KiiBucket._bucketWithName(bucketName, this);
    };
    ...
    KiiUser.prototype._authenticate = function(callbacks) {
      ...
      _thisUser = this;
      Kii.logger("Authenticating user:");
      Kii.logger(this);
      Kii.logger("Email verified: " + this._emailVerified);
      Kii.logger("Phone verified: " + this._phoneVerified);
    ...
    */
    ...
    KiiUser.authenticate = function(userIdentifier, password, callbacks) {
      ...
      try {
        Kii.logger("UserIdentifier: " + userIdentifier);
    ...
    KiiUser.prototype._updateWithJSON = function(json) {
      ...
      for (key in json) {
        ...
        if (key === "userID" || key === "id") {
          ...
          Kii.logger("Email verified: " + value);
          this._emailVerified = value;
        } else if (key === "phoneNumberVerified") {
          Kii.logger("Phone verified: " + value);
  ...
  KiiUtilities = (function() {
    ...
    KiiUtilities._assertLocalPhoneIsValid = function(value) {
      if (!KiiUtilities._validateLocalPhone(value)) {
        throw new InvalidLocalPhoneNumberException;
      }
    };
  ...
  */
  ...
  root.KiiAppAdminContext = (function() {
    ...
    */
    ...
    KiiAppAdminContext.prototype.bucketWithName = function(bucketName) {
      ...
      adminBucket = new KiiBucketAdmin(bucketName, null, this._token);
      return adminBucket;
    };
    ...
    */
    ...
    KiiAppAdminContext.prototype.groupWithName = function(groupName) {
      ...
      group = KiiGroupAdmin._groupWithName(groupName, this);
      return group;
    };
    ...
    */
    ...
    KiiAppAdminContext.prototype.userWithID = function(userid) {
      ...
      user = KiiUserAdmin._userWithID(userid, this);
      return user;
    };
  ...
  root.KiiACLAdmin = (function(_super) {
    ...
    KiiACLAdmin.prototype._groupWithID = function(id) {
      ...
      group = KiiGroupAdmin._groupWithID(id, this._adminToken);
      return group;
    };
    ...
    KiiACLAdmin.prototype._userWithID = function(id) {
      ...
      user = KiiUserAdmin._userWithID(id, this._adminToken);
      return user;
    };
  ...
  root.KiiGroupAdmin = (function(_super) {
    ...
    KiiGroupAdmin._groupWithName = function(groupName, adminContext) {
      return KiiGroupAdmin._groupWithNameAndMembers(groupName, null, adminContext);
    };

    KiiGroupAdmin._groupWithNameAndMembers = function(groupName, members, adminContext) {
      var group;

      group = new KiiGroupAdmin(adminContext);
      group._setName(groupName);
      group._setAddMembers(members);
      return group;
    };
    ...
    KiiGroupAdmin.prototype.bucketWithName = function(name) {
      ...
      bucket = new KiiBucketAdmin(name, this, this._adminContext._getToken());
      return bucket;
    };
    ...
    KiiGroupAdmin.prototype._userWithID = function(id) {
      ...
      user = KiiUserAdmin._userWithID(id, this._adminContext._getToken());
      return user;
    };
  ...
  root.KiiObjectAdmin = (function(_super) {
    ...
    KiiObjectAdmin.prototype._getRequest = function(spec) {
      ...
      Kii.logger("admin req: " + this._adminToken);
    ...
    KiiObjectAdmin.objectWithBucket = function(bucket, type, adminToken) {
      ...
      Kii.logger("Creating object w type: " + type);
      obj = new KiiObjectAdmin(adminToken);
      obj._setBucket(bucket);
      obj._setObjectType(type);
      Kii.logger(obj);
      return obj;
  ...
  root.KiiUserAdmin = (function(_super) {
    ...
    KiiUserAdmin._userWithID = function(id, adminContext) {
      ...
      user = new KiiUserAdmin(adminContext);
      user._setUUID(id);
      return user;
    };
    ...
    KiiUserAdmin.prototype.bucketWithName = function(bucketName) {
      ...
      return bucket = new KiiBucketAdmin(bucketName, this, this._adminContext._getToken());
    };
